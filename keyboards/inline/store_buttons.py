...
# GENDER MARKUP
m = InlineKeyboardButton(text='Мужской', callback_data=gender_cd.new(gender=1))
w = InlineKeyboardButton(text='Женский', callback_data=gender_cd.new(gender=2))
all_genders = InlineKeyboardButton(text='Унисекс', callback_data=gender_cd.new(gender=3))
skip = InlineKeyboardButton(text='Пропустить', callback_data=gender_cd.new(gender=0))
